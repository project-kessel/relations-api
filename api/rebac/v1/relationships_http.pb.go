...
func RegisterRelationshipsHTTPServer(s *http.Server, srv RelationshipsHTTPServer) {
	r := s.Route("/")
	r.POST("/relationships", _Relationships_CreateRelationships0_HTTP_Handler(srv))
	r.GET("/relationships", _Relationships_ReadRelationships0_HTTP_Handler(srv))
	r.DELETE("/relationships", _Relationships_DeleteRelationships0_HTTP_Handler(srv))
}
