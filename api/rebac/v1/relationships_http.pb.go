...
func RegisterRelationshipsHTTPServer(s *http.Server, srv RelationshipsHTTPServer) {
	r := s.Route("/")
	r.POST("/api/relationships", _Relationships_CreateRelationships0_HTTP_Handler(srv))
	r.GET("/api/relationships", _Relationships_ReadRelationships0_HTTP_Handler(srv))
	r.DELETE("/api/relationships", _Relationships_DeleteRelationships0_HTTP_Handler(srv))
}
