...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	checkBulkForUpdateUsecase := biz.NewCheckBulkForUpdateUsecase(spiceDbRepository, logger)
	checkService := service.NewCheckService(logger, checkUsecase, checkForUpdateUsecase, checkBulkUsecase, checkBulkForUpdateUsecase)
